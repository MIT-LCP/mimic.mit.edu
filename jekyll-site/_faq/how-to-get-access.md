...
layout: default
nav_order: 41
permalink: /faq/how-to-get-access/
---
...
- Provide valid institutional email address (not required, but helpful)
- Include the correct CITI training: make sure it is "Data or Specimens Only Research"
- Incllude the CITI *Completion Report*, not just the certificate
