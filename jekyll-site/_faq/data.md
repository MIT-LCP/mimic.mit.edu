...
Patients can be linked across distinct MIMIC databases using their identifier. Databases which can currently be linked include MIMIC-IV, MIMIC-IV-ED, MIMIC-IV-ECHO, and MIMIC-CXR.

- **Hospital (hosp)**: `subject_id`, `hadm_id`
- **ICU**: `subject_id`, `hadm_id`, `stay_id`
- **Emergency Department (ED)**: `hadm_id`
